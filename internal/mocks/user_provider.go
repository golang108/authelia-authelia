...
func (m *MockUserProvider) AddUser(username, displayName, password string, opts ...func(*authentication.NewUserAdditionalAttributesOpts)) error {
	m.ctrl.T.Helper()
...
func (m *MockUserProvider) GetUser(username string) (*authentication.UserDetails, error) {
	m.ctrl.T.Helper()
